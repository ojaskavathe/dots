...
$exe = Get-ChildItem -Path $extractDir -Filter "kanata_windows_gui_winIOv2_x64.exe" -Recurse | Select-Object -First 1
if (-not $exe) {
    Write-Error "kanata_windows_gui_winIOv2_x64.exe not found in the downloaded archive."
    exit 1
}
